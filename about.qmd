...
I'm currently the Data Training Program Manager at the [National Center for Ecological Analysis and Synthesis (NCEAS) Learning Hub](https://www.nceas.ucsb.edu/learning-hub). My role is to manage, maintain, and develop NCEAS’s growing data science training portfolio and coordinate and conduct training sessions.
...
I helped mobilize data from "researchers' computers" to an open data repository, the [Environmental Data Initiative (EDI)](https://edirepository.org/). To successfully achieve this, I had to do quality checks on data sets and transform them to comply with [FAIR](https://www.nature.com/articles/sdata201618) to the extent possible, and I systematized the process for documenting and producing detailed metadata.
